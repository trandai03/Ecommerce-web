...
{{--                                    </div><!-- End .form-choice -->--}}
    ...
    <link href="{{url('assets/js/jquery.min.js')}}"></link>
    <link href="{{url('assets/js/bootstrap.bundle.min.js')}}"></link>
    <script src="./assets/js/bootstrap.bundle.min.js"></script>
    <script src="./assets/js/jquery.hoverIntent.min.js"></script>
    <link href="{{url('assets/js/jquery.hoverIntent.min.js')}}"></link>
    <script src="./assets/js/jquery.waypoints.min.js"></script>
    <link href="{{url('assets/js/jquery.waypoints.min.js')}}"></link>
    <script href="{{('./assets/js/superfish.min.js')}}"></script>
    <link href="{{url('assets/js/superfish.min.js')}}"></link>
    <!-- Main JS File -->
    <link href="{{url('assets/js/main.js')}}"></link>
